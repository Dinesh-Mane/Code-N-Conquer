...
## Problem Statement
तुला 0, 1, 2 यांमधील element असलेला एक array दिला आहे, जे तीन वेगवेगळ्या रंगांचं representation करत आहेत:  
- 0 = लाल (red)
- 1 = पांढरा (white)
- 2 = निळा (blue)  

हा array in-place म्हणजेच additonal array न वापरता sort करायचा आहे – अशा पद्धतीने की सगळे 0 सुरुवातीला, मग 1 आणि शेवटी 2 येतील.  
